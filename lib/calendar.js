    ...
    .then(function (response) {
        return new Promise(function (resolve, reject) {
            xml2js.parseString(response, { explicitArray: false }, function (err, xmlObj) { // ignoreAttrs : true ??
                ...
                resolve(self._parseEntry(entry)); // return calendar entry array
            });
        });
    });
}
...
Calendar.prototype.getAvailabilityForRoom = function (roomMailbox, startTime, endTime) {
    ...
    .then(function (response) {
        return new Promise(function (resolve, reject) {
            xml2js.parseString(response, { explicitArray: false }, function (err, xmlObj) {
                var calendarEvents = xmlObj['s:Envelope']['s:Body']
                                ['GetUserAvailabilityResponse']
                                ['FreeBusyResponseArray']['FreeBusyResponse']['FreeBusyView']
                                ['CalendarEventArray'];
                var entries = null;
                if (calendarEvents != null) {
                    ...
                    entries = calEvents.map(function (obj) {
                            ...
                            item.Start = obj['CalendarEventDetails']['StartTime'];
                            item.End = obj['CalendarEventDetails']['EndTime'];
                            return item;
                        });
                }
                resolve(entries); 
